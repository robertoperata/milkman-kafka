...
public class Notification {
    ...
    public Notification withTotalLoyaltyPoint(Double totalLoyaltyPoint) {
        this.totalLoyaltyPoint = totalLoyaltyPoint;
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("invoiceNumber", invoiceNumber).append("customerCardNo", customerCardNo).append("totalAmount", totalAmount).append("earnedLoyaltyPoints", earnedLoyaltyPoints).append("totalLoyaltyPoint", totalLoyaltyPoint).toString();
    }
