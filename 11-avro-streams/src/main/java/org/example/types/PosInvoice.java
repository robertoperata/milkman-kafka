...
public class PosInvoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @param CustomerCarNo The new value for CustomerCarNo
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: CustomerCarNo = (java.lang.Double)value$; break;
  ...
  /**
   * Gets the value of the 'CustomerCarNo' field.
   * @return The value of the 'CustomerCarNo' field.
   */
  public java.lang.Double getCustomerCarNo() {
    return CustomerCarNo;
  }

  /**
   * Sets the value of the 'CustomerCarNo' field.
   * @param value the value to set.
   */
  public void setCustomerCarNo(java.lang.Double value) {
    this.CustomerCarNo = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PosInvoice>
    ...
    private java.lang.Double CustomerCarNo;
    ...
    private Builder(org.example.types.PosInvoice.Builder other) {
      ...
      if (isValidValue(fields()[2], other.CustomerCarNo)) {
        this.CustomerCarNo = data().deepCopy(fields()[2].schema(), other.CustomerCarNo);
    ...
    /**
      * Sets the value of the 'CustomerCarNo' field.
      * @param value The value of 'CustomerCarNo'.
      * @return This builder.
      */
    public org.example.types.PosInvoice.Builder setCustomerCarNo(java.lang.Double value) {
    ...
    /**
      * Checks whether the 'CustomerCarNo' field has been set.
      * @return True if the 'CustomerCarNo' field has been set, false otherwise.
      */
    public boolean hasCustomerCarNo() {
      return fieldSetFlags()[2];
    }


    /**
      * Clears the value of the 'CustomerCarNo' field.
      * @return This builder.
      */
    public org.example.types.PosInvoice.Builder clearCustomerCarNo() {
      CustomerCarNo = null;
    ...
    public PosInvoice build() {
      try {
        ...
        record.CustomerCarNo = fieldSetFlags()[2] ? this.CustomerCarNo : (java.lang.Double) defaultValue(fields()[2]);
